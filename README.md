...
## Prosty przykładowy program CLI

Dla szybkiego pokazu działania dodałem prosty program konsolowy:
...
Program wypisze przykładowy raport pogodowy i działa lokalnie (bez zewnętrznego API).
